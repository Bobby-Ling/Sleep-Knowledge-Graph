...
<!-- <div style="background-color: white; display: inline-block;">
    <img src="Assets/设计文档/graph-1.svg" alt="graph">
</div> -->
...
<!-- ![alt text](Assets/设计文档/VP9RIm9168RlzrSCz2CAkx4awQPkkWgw6TpLbdH7PiSY8iZAi-vA9od30oHPaHP4sLhwOzev-2_QRIaighcQUR-FvtlVZ_7h16AIY4KbVKtLuX33692LC4n4IH1fP1765B2WXZ3IKPY0PJYlg6ET-YgKqOQgHK0OHdL56Yl1457NLR89jYG0bjmX0HH564nCJGRcWZEEEAV9FwLP65gBO9JugWG_Zbj1M5Rmp_uPZD76Tt7RCU5EatmiTy.svg) -->
...
2. 症状选择
    ...
    ![alt text](Assets/设计文档/image-11.png)
    
3. 症状分析和量表推荐

    ![alt text](Assets/设计文档/92e67b6486f61d772e79dd7b342c6d34.jpeg)
...
4. 量表填写(可选)
    ...
    ![alt text](Assets/设计文档/e5d015b3ba94cb6f707231384a2ac05d.jpeg)
    
5. 量表评估

    综合完成的量表进行评估:

    ![alt text](Assets/设计文档/2df8ea77a68ed38304dd84db4bd2bb9d.jpeg)
...
6. 病历上传和分析(可选)
    ...
    ![alt text](Assets/设计文档/7ea5f6036d0855461040c532295d83b9.jpeg)
...
7. 综合分析
    ...
    ![alt text](Assets/设计文档/image-16.png)
    
    ![alt text](Assets/设计文档/image-15.png)
    
    ![alt text](Assets/设计文档/image-17.png)
...
1. 基于评估结果的分析
    ...
    ![alt text](Assets/设计文档/2aed8832019c17f291edf81066b74c48.jpeg)
    ![alt text](Assets/设计文档/b48c90b199d461df0e96d843d4a8a182.jpeg)
2. 问题推荐
...
<!-- ![alt text](Assets/设计文档/image-23.png) -->
